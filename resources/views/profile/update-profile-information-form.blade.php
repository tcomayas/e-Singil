<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="name" type="text" class="block w-full mt-1" wire:model.defer="state.name" required autocomplete="name" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="email" type="email" class="block w-full mt-1" wire:model.defer="state.email" required autocomplete="username" />
