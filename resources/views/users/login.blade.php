        ...
        <x-card class="p-10 ">
            <div class="flex">
                <div id="first" class="flex-1">
                    <a href="/"><img class="w-4/5 h-full rounded" src="{{ asset('images/store.jpg') }}" alt=""/></a>
                </div>
                ...
                <div class="flex-1 mt-24">
                    ...
                    <form method="POST" action="/users/authenticate">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="email" class="w-full p-2 border border-gray-200 rounded" name="email" value="{{ old('email') }}"/>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="password" class="w-full p-2 border border-gray-200 rounded" name="password" value="{{ old('password') }}"/>
